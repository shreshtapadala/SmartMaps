        ...
        if (endResult.results && endResult.results.length > 0) {
            ...
            if(localTime <= 20 && localTime >= 6){
                ...
                if (cyclingTimeInSeconds <= 3600) {
                    ...
                    text = "Cycling is the Optimal mode to reach your destination. \n You can arrive in " + minutes + " minutes and also burn " + (walkingTimeInSeconds/60)*6.5 + "calories on your journey. \n By choosing to cycle, you're helping to decrease your carbon footprint, reducing traffic congestion and supporting a healthier planet. Enjoy the ride and the positive impact you're making. \n Happy Cycling! 🚴";
                    document.getElementById('bestWayContent').innerText = text;
                    document.getElementById('bestWay').style.display = 'block';
                    handleSpeechSynthesis();
                    return;
